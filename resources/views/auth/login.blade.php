...
<head>
    ...
    <title>Login Pages | Satria Agung</title>
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo">
                                    <img src="{{ asset('template/templateAdmin') }}/assets/img/sa.png"
                                        alt="Satria Agung" width="25">
                                </span>
                        ...
                        <p class="mb-4">Silahkan login untuk masuk ke Aplikasi Satria Agung</p>
